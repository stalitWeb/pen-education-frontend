                  ...
                  <div className='layout-layer flex flex-col lg:flex-row justify-center capitalize py-6 gap-3 lg:gap-10'>
                    <div className='flex-[1.5] flex flex-row justify-between items-cente gap-5'>
                      ...
                      <ul className='hidden text-lightblue lg:flex flex-row justify-center items-center text-[16px] montserrat font-normal gap-5'>
                        <li className='desktop-menu relative flex flex-col'>
                          <a href='/blog-single'>home</a>
                        </li>

                        <li className='desktop-menu relative flex flex-col'>
                          <a href='/blog-single' className='flex flex-row justify-center items-center gap-1'>
                            <span>Pages</span>
                    ...
                    <div className={!toggle? 'mobile-menu menu h-[0px] overflow-hidden  flex flex-col lg:hidden text-[16px] montserrat font-normal gap-5' : 'menu w-full overflow-hidde flex flex-col lg:hidden text-[16px] montserrat font-normal py-4 gap-5'}>
                      <ul className='flex flex-col text-[15px] text-lightblue montserrat font-normal gap-5'>
                        ...
                        <li className='mobile-menu-link flex flex-col relative'>
                          <a href='/blog-single' className='flex flex-row items-center gap-1'>
                            <span>Pages</span>
                    ...
                    <div className='flex-1 flex justify-between items-center gap-10'>
                      ...
                      <div className='flex flex-row justify-center items-between montserrat font-semibold gap-3'>
                        <a href='/blog-single' className='btn text-center text-white px-4 py-4 outline-none rounded-[10px] '>login</a>
                        <a href='/blog-single' className='btn text-center text-white px-4 py-4 outline-none rounded-[10px] '> sign up</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <section className='business-section flex justify-center items-center px-6 md:px-16'>
                <div className='box-width w-full xl:max-w-[1280px]'>
                  <div className='layout-layer flex flex-col justify-center items-center py-12 gap-10'>
                    <div className='w-full flex flex-col'>
                        <div className='w-full flex flex-row items-center gap-3'>
                          <h4 className='text-lightgreen montserrat font-semibold uppercase'>Why Choose Penn</h4>
                          <span className='title-line w-[150px]'></span>
                        </div>
                        <h2 className='text-lightblue text-[30px] md:text-[40px] montserrat font-bold'>Find the {' '}
                          <span className='text-lightgreen'>
                            <u>best features</u>{" "}
                          </span>
                          of Penn.
                    ...
                    <div className='w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5'>
                      <div className='business-card flex- flex flex-col px-6 py-4 gap-3'>
                        <div className='w-full flex flex-row gap-3'>
                          <div className='bg-[#e8f5ff] w-[74px] h-[74px] flex flex-col justify-center items-center rounded-full'>
                            <IoBookOutline className='w-[50%] h-[50%] text-[#4154f1]' />
                          </div>
                      ...
                      <div className='business-card flex- flex flex-col px-6 py-4 gap-3'>
                        <div className='w-full flex flex-row gap-3'>
                          <div className='bg-[#ECFFFC] w-[74px] h-[74px] flex flex-col justify-center items-center rounded-full'>
                            <FaRegHeart className='w-[50%] h-[50%] text-[#4154f1]' />
                          </div>
                      ...
                      <div className='business-card flex- flex flex-col px-6 py-4 gap-3'>
                        <div className='w-full flex flex-row gap-3'>
                          <div className='bg-[#E8F5FF] w-[74px] h-[74px] flex flex-col justify-center items-center rounded-full'>
                            <FaUser className='w-[50%] h-[50%] text-[#4154f1]' />
                          </div>
                      ...
                      <div className='business-card flex- flex flex-col px-6 py-4 gap-3'>
                        <div className='w-full flex flex-row gap-3'>
                          <div className='bg-[#E3F9F6] w-[74px] h-[74px] flex flex-col justify-center items-center rounded-full'>
                            <FaRegEye className='w-[50%] h-[50%] text-[#4154f1]' />
                          </div>
                      ...
                      <div className='business-card flex- flex flex-col px-6 py-4 gap-3'>
                        <div className='w-full flex flex-row gap-3'>
                          <div className='bg-[#FFF6EB] w-[74px] h-[74px] flex flex-col justify-center items-center rounded-full'>
                            <FaRegLightbulb className='w-[50%] h-[50%] text-[#4154f1]' />
                          </div>
                      ...
                      <div className='business-card flex- flex flex-col px-6 py-4 gap-3'>
                        <div className='w-full flex flex-row gap-3'>
                          <div className='bg-[#E8FFEA] w-[74px] h-[74px] flex flex-col justify-center items-center rounded-full'>
                            <AiOutlineMail className='w-[50%] h-[50%] text-[#4154f1]' />
                          </div>
